...
import (
	...
	"github.com/wstiehler/zpecreateuser-api/internal/api/middlewares"
	"github.com/wstiehler/zpecreateuser-api/internal/api/routes"
...
func Start(input Input, companyService createuser.Service, db *gorm.DB) {
	r := gin.New()
